...
window.Achievements = (() => {
  ...
  const TROPHIES = [
    ...
    { n: 4, id: "m4_bigwin_250m",    name: "大勝ち",     desc: "1回の払い戻しが250万以上" },
    { n: 5, id: "m5_10streak",       name: "十連",       desc: "ダブルアップ10連成功（強制終了）" },
    { n: 6, id: "m6_yakuman",        name: "役満",       desc: "ロイヤル or ファイブカードを成立" },
    { n: 7, id: "m7_goal_1500m",     name: "目標達成",   desc: "所持コインが1500万に到達" },
    { n: 8, id: "m8_secret_3000m",   name: "想定外",     desc: "所持コインが3000万に到達" },
  ...
  function trophyLine(mode, trophyId) {
    const L = {
      auditor: {
        ...
        m6_yakuman: "役満成立を確認。\n例外扱い。",
        m7_goal_1500m: "1500万到達。\n目標を満たす。",
        m8_secret_3000m: "3000万到達。\n想定外。",
        m9_bankrupt: "所持コインが0。\n再起動を推奨。",
      ...
      chogi: {
        ...
        m4_bigwin_250m: "250万以上か。\n浮かれるなよ。",
        m5_10streak: "10連だ。\nここで終わりだな。",
        m6_yakuman: "役満。\n……認める。",
        m7_goal_1500m: "1500万到達。\n次の一手を考えろ。",
        m8_secret_3000m: "3000万。\nやり過ぎだ。",
        m9_bankrupt: "0になったか。\n学べ。",
  ...
  function checkCoinMilestones() {
    ...
    const ids = [];
    if (c >= 15000000) ids.push("m7_goal_1500m");
    if (c >= 30000000) ids.push("m8_secret_3000m");
    unlockAndQueue(ids);
  }
  ...
  function renderTrophies() {
    ...
    for (const t of TROPHIES) {
      ...
      if (got[t.id]) {
        left.innerHTML = `<div class="list-title">${t.n}. ${t.name}</div><div class="list-sub">${t.desc}</div>`;
